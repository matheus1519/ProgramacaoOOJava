...
{
	private JTextField tNome, tCpf, tNascimento, tSalario, tFuncao,tPesquisa;
	...
	public TelaPedido() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Selecione um Funcion\u00E1rio", "Caralho"}));
